...
import { GameController, Target, ArrowLeft, Lightning } from '@phosphor-icons/react'
...
export function GameCorner({ onNavigateBack, userEmail }: GameCornerProps) {
  ...
  const games: GameModule[] = [
    ...
    },
    {
      ...
      gradient: 'from-[oklch(0.65_0.25_30)] via-[oklch(0.60_0.22_15)] to-[oklch(0.65_0.25_30)]',
      available: true,
    },
  ]
    ...
    return (
      <div className="min-h-screen" style={{
        ...
        <div style={{
          ...
          <div className="relative bg-gradient-to-r from-[oklch(0.65_0.25_30)] via-[oklch(0.60_0.22_15)] to-[oklch(0.65_0.25_30)] py-8 shadow-xl border-b-4 border-white/10">
